...
public class practiceAdvancedLocators {
    ...
    public void test1(){
        ...
        //print ou tht text of the first link on the webpage
    ...
    public void printPhoneBrands() throws InterruptedException{
        ...
        driver.findElement(By.cssSelector("#twotabsearchtextbox")).sendKeys("iphone"+ Keys.ENTER); //looking for single method
       Thread.sleep(3000);
    ...
    public void test3() throws InterruptedException {
        ...
        Assert.assertTrue("Welcome text contains wrong name",welcomeText.contains("tes6"));
