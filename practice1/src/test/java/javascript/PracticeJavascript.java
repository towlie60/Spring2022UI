...
public class PracticeJavascript {
    ...
    public void etsyTest() throws InterruptedException {
       ...
       // js.executeScript("document.getElementById('join_neu_email_field').setAttribute('style',arguments[0]);", "border: 2px solid green");
        //Thread.sleep(2000);
       ...
       // js.executeScript("document.getElementById('join_neu_password_field').setAttribute('style',arguments[0]);", "border: 2px solid green");
        //Thread.sleep(2000);
